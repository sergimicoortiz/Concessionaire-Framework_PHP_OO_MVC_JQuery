...
function clicks_login() {
    ...
    $(document).on('click', '#social-google', function (e) {
        e.preventDefault();
        social_singin_data('google');
    })//end click

    $(document).on('click', '#social-github', function (e) {
        e.preventDefault();
        social_singin_data('github');
    })//end click
...
function social_singin_data(option) {
